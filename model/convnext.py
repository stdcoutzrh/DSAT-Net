...
"""
mainly copyed from: https://github.com/facebookresearch/ConvNeXt/blob/main/models/convnext.py
"""
    ...
    def __init__(self, in_chans=3, sp=True,
        ...
        if  self.sp: # for 512x512 input
            self.sfs = nn.ModuleList(
                [SpatialFormer(96,128,vis=False),
                SpatialFormer(192,64,vis=False),
                SpatialFormer(384,32,vis=False),
                SpatialFormer(768,16,vis=False)]
            )
